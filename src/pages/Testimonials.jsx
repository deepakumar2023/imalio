  ...
  const feedbacks = [
    {
      ...
      image: "/testimonialimages/phone.avif", // replace with your image path
      rating: 5,
    },
    {
      name: "Sarah",
      ...
      image: "/testimonialimages/photo.avif", // replace with your image path
      rating: 5,
    },
  ];
    ...
    <section className="py-16 bg-white">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="mt-2 text-gray-600">
          Hear what our clients say about our exceptional services and results.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
          {feedbacks.map((feedback, index) => (
            ...
            >
              ...
              {/* Review Text */}
              <p className="text-gray-800 mb-6">{feedback.review}</p>
